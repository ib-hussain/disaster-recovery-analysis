...
Explore our interactive findings deployed via GitHub Pages:
- 🌍 **[Global Resilience Dashboard](pictures/dashboard.html)**: A comprehensive view integrating spatial, temporal, and relational dimensions of global resilience.
- 🗺️ **[Choropleth Map: Risk & Resilience Gradients](pictures/geo_map.html)**: Visualising geographical distributions of the RRS, highlighting regional resilience clusters.
- 📈 **[Temporal Evolution of Resilience](pictures/line_chart.html)**: Tracking how major world regions' post-disaster recovery capacities have fluctuated over the last 25 years.
- 📉 **[Multivariate Scatter Plot](pictures/scatter_plot.html)**: Investigating the structural relationship between HDI, GDP growth, and the Resilience Recovery Score.
